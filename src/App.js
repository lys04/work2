...
//  合约地址
const UNIVERSAL_POINTS_ADDRESS = "0xbcA1E489CD448df3aE52EA1B13d71e9C36116B06";
const POINTS_EXCHANGE_ADDRESS  = "0xf37396ABA54371Ce3Eed51302482205DD6c0E3E4";
...
function App() {
  ...
  <div className="App">
    ...
    {!isWalletConnected ? (
      <div>
        <button className="primary-button" onClick={connectWallet}>连接钱包</button>
      </div>
    ) : (
      <div className="grid-container">
        ...
        <div className="card">
          ...
          />
          <button className="primary-button" onClick={handleDeploy}>部署通用积分发行合约</button>
        </div>
        ...
        <div className="card">
          ...
          />
          <button className="primary-button" onClick={handleLoadContract}>导入合约</button>
        </div>
        ...
        <div className="card">
          ...
          <input
            ...
            placeholder="额度"
          />
          <button className="primary-button" onClick={issueRegularPoints}>发行积分</button>
        </div>
        ...
        <div className="card">
          ...
          <button className="primary-button" onClick={getPointsBalance}>更新余额</button>
        </div>

        <div className="card full-width-card">
          <h2>积分兑换（普通积分兑换成通用积分）</h2>
          <p>汇率: 1 {symbol || 'RLP'} = {exchangeRate} UPT</p>
          <button className="primary-button" onClick={exchangePoints}>兑换</button>
        </div>
      </div>
    )}
  </div>
